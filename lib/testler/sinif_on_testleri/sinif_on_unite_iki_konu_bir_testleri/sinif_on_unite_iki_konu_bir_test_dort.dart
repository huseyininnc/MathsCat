...
class SinifOnUniteIkiKonuBirTestDort extends StatefulWidget {
  @override
  _SinifOnUniteIkiKonuBirTestDortState createState() =>
      _SinifOnUniteIkiKonuBirTestDortState();
}

class _SinifOnUniteIkiKonuBirTestDortState
    extends State<SinifOnUniteIkiKonuBirTestDort> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteIkiKonuBirTestDortCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_iki_konu_bir_test_dort/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteIkiKonuBirTestDort = true,
                true,
                'sinif10_7');
          }
