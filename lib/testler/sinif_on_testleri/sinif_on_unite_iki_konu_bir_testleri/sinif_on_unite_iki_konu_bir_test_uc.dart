...
class SinifOnUniteIkiKonuBirTestUc extends StatefulWidget {
  @override
  _SinifOnUniteIkiKonuBirTestUcState createState() =>
      _SinifOnUniteIkiKonuBirTestUcState();
}

class _SinifOnUniteIkiKonuBirTestUcState
    extends State<SinifOnUniteIkiKonuBirTestUc> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteIkiKonuBirTestUcCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_iki_konu_bir_test_uc/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteIkiKonuBirTestUc = true,
                true,
                'sinif10_6');
          }
