...
class SinifOnUniteBesKonuIkiTestBir extends StatefulWidget {
  @override
  _SinifOnUniteBesKonuIkiTestBirState createState() =>
      _SinifOnUniteBesKonuIkiTestBirState();
}

class _SinifOnUniteBesKonuIkiTestBirState
    extends State<SinifOnUniteBesKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteBesKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_bes_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteBesKonuIkiTestBir = true,
                true,
                'sinif10_15');
          }
