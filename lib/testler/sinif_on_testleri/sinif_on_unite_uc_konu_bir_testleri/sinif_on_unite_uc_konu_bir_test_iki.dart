...
class SinifOnUniteUcKonuBirTestIki extends StatefulWidget {
  @override
  _SinifOnUniteUcKonuBirTestIkiState createState() =>
      _SinifOnUniteUcKonuBirTestIkiState();
}

class _SinifOnUniteUcKonuBirTestIkiState
    extends State<SinifOnUniteUcKonuBirTestIki> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteUcKonuBirTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_uc_konu_bir_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteUcKonuBirTestIki = true,
                true,
                'sinif10_9');
          }
