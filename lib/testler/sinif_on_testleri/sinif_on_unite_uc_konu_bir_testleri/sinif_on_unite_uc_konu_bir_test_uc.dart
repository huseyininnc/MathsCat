...
class SinifOnUniteUcKonuBirTestUc extends StatefulWidget {
  @override
  _SinifOnUniteUcKonuBirTestUcState createState() =>
      _SinifOnUniteUcKonuBirTestUcState();
}

class _SinifOnUniteUcKonuBirTestUcState
    extends State<SinifOnUniteUcKonuBirTestUc> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteUcKonuBirTestUcCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_uc_konu_bir_test_uc/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteUcKonuBirTestUc = true,
                true,
                'sinif10_10');
          }
