...
class SinifOnUniteUcKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnUniteUcKonuBirTestBirState createState() =>
      _SinifOnUniteUcKonuBirTestBirState();
}

class _SinifOnUniteUcKonuBirTestBirState
    extends State<SinifOnUniteUcKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteUcKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_uc_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteUcKonuBirTestBir = true,
                true,
                'sinif10_8');
          }
