...
class SinifOnUniteBirKonuIkiTestBir extends StatefulWidget {
  @override
  _SinifOnUniteBirKonuIkiTestBirState createState() =>
      _SinifOnUniteBirKonuIkiTestBirState();
}

class _SinifOnUniteBirKonuIkiTestBirState
    extends State<SinifOnUniteBirKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteBirKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_bir_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteBirKonuIkiTestBir = true,
                true,
                'sinif10_3');
          }
