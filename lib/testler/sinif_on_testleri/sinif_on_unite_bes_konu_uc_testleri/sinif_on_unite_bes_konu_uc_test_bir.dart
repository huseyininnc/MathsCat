...
class SinifOnUniteBesKonuUcTestBir extends StatefulWidget {
  @override
  _SinifOnUniteBesKonuUcTestBirState createState() =>
      _SinifOnUniteBesKonuUcTestBirState();
}

class _SinifOnUniteBesKonuUcTestBirState
    extends State<SinifOnUniteBesKonuUcTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteBesKonuUcTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_bes_konu_uc_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteBesKonuUcTestBir = true,
                true,
                'sinif10_16');
          }
