...
class SinifOnUniteBesKonuUcTestUc extends StatefulWidget {
  @override
  _SinifOnUniteBesKonuUcTestUcState createState() =>
      _SinifOnUniteBesKonuUcTestUcState();
}

class _SinifOnUniteBesKonuUcTestUcState
    extends State<SinifOnUniteBesKonuUcTestUc> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteBesKonuUcTestUcCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_bes_konu_uc_test_uc/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteBesKonuUcTestUc = true,
                true,
                'sinif10_18');
          }
