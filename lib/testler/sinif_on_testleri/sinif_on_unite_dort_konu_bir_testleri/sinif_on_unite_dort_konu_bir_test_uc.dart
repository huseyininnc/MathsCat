...
class SinifOnUniteDortKonuBirTestUc extends StatefulWidget {
  @override
  _SinifOnUniteDortKonuBirTestUcState createState() =>
      _SinifOnUniteDortKonuBirTestUcState();
}

class _SinifOnUniteDortKonuBirTestUcState
    extends State<SinifOnUniteDortKonuBirTestUc> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteDortKonuBirTestUcCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_dort_konu_bir_test_uc/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteDortKonuBirTestUc = true,
                true,
                'sinif10_13');
          }
