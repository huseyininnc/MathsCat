...
class SinifOnUniteDortKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnUniteDortKonuBirTestBirState createState() =>
      _SinifOnUniteDortKonuBirTestBirState();
}

class _SinifOnUniteDortKonuBirTestBirState
    extends State<SinifOnUniteDortKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteDortKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_dort_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteDortKonuBirTestBir = true,
                true,
                'sinif10_11');
          }
