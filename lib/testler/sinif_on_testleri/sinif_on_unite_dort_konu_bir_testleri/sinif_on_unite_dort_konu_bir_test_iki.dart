...
class SinifOnUniteDortKonuBirTestIki extends StatefulWidget {
  @override
  _SinifOnUniteDortKonuBirTestIkiState createState() =>
      _SinifOnUniteDortKonuBirTestIkiState();
}

class _SinifOnUniteDortKonuBirTestIkiState
    extends State<SinifOnUniteDortKonuBirTestIki> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteDortKonuBirTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_dort_konu_bir_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteDortKonuBirTestIki = true,
                true,
                'sinif10_12');
          }
