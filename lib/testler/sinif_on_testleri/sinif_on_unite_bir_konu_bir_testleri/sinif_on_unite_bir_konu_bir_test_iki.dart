...
class SinifOnUniteBirKonuBirTestIki extends StatefulWidget {
  @override
  _SinifOnUniteBirKonuBirTestIkiState createState() =>
      _SinifOnUniteBirKonuBirTestIkiState();
}

class _SinifOnUniteBirKonuBirTestIkiState
    extends State<SinifOnUniteBirKonuBirTestIki> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteBirKonuBirTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_bir_konu_bir_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteBirKonuBirTestIki = true,
                true,
                'sinif10_2');
          }
