...
class SinifOnUniteBirKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnUniteBirKonuBirTestBirState createState() =>
      _SinifOnUniteBirKonuBirTestBirState();
}

class _SinifOnUniteBirKonuBirTestBirState
    extends State<SinifOnUniteBirKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteBirKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_bir_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteBirKonuBirTestBir = true,
                true,
                'sinif10_1');
          }
