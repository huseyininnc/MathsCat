...
class SinifOnUniteAltiKonuBirTestIki extends StatefulWidget {
  @override
  _SinifOnUniteAltiKonuBirTestIkiState createState() =>
      _SinifOnUniteAltiKonuBirTestIkiState();
}

class _SinifOnUniteAltiKonuBirTestIkiState
    extends State<SinifOnUniteAltiKonuBirTestIki> {
  List<String> sorular = VeriTabaniSinifOn().soruResimleriOnBirli;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteAltiKonuBirTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_alti_konu_bir_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteAltiKonuBirTestIki = true,
                true,
                'sinif10_20');
          }
