...
class SinifOnUniteAltiKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnUniteAltiKonuBirTestBirState createState() =>
      _SinifOnUniteAltiKonuBirTestBirState();
}

class _SinifOnUniteAltiKonuBirTestBirState
    extends State<SinifOnUniteAltiKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteAltiKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_alti_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteAltiKonuBirTestBir = true,
                true,
                'sinif10_19');
          }
