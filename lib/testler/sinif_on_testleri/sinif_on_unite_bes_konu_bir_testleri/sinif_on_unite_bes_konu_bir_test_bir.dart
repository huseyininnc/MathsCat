...
class SinifOnUniteBesKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnUniteBesKonuBirTestBirState createState() =>
      _SinifOnUniteBesKonuBirTestBirState();
}

class _SinifOnUniteBesKonuBirTestBirState
    extends State<SinifOnUniteBesKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOn().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifOn().sinifOnUniteBesKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on/soruresim_sinif_on_unite_bes_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnUniteBesKonuBirTestBir = true,
                true,
                'sinif10_14');
          }
