...
class SinifOnBirTemelMatUniteUcKonuIkiTestBir extends StatefulWidget {
  @override
  _SinifOnBirTemelMatUniteUcKonuIkiTestBirState createState() =>
      _SinifOnBirTemelMatUniteUcKonuIkiTestBirState();
}

class _SinifOnBirTemelMatUniteUcKonuIkiTestBirState
    extends State<SinifOnBirTemelMatUniteUcKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirTemelMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirTemelMat()
      .sinifOnBirTemelMatUniteUcKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_temel_mat/soruresim_sinif_on_bir_temel_mat_unite_uc_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirTemelMatUniteUcKonuIkiTestBir = true,
                true,
                'sinif11_temel_mat_7');
          }
