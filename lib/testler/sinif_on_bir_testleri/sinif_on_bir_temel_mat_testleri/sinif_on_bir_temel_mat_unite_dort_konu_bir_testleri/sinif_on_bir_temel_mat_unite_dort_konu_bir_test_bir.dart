...
class SinifOnBirTemelMatUniteDortKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirTemelMatUniteDortKonuBirTestBirState createState() =>
      _SinifOnBirTemelMatUniteDortKonuBirTestBirState();
}

class _SinifOnBirTemelMatUniteDortKonuBirTestBirState
    extends State<SinifOnBirTemelMatUniteDortKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirTemelMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirTemelMat()
      .sinifOnBirTemelMatUniteDortKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_temel_mat/soruresim_sinif_on_bir_temel_mat_unite_dort_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
