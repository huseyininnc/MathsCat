...
class SinifOnBirTemelMatUniteBirKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirTemelMatUniteBirKonuBirTestBirState createState() =>
      _SinifOnBirTemelMatUniteBirKonuBirTestBirState();
}

class _SinifOnBirTemelMatUniteBirKonuBirTestBirState
    extends State<SinifOnBirTemelMatUniteBirKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirTemelMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirTemelMat()
      .sinifOnBirTemelMatUniteBirKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_temel_mat/soruresim_sinif_on_bir_temel_mat_unite_bir_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirTemelMatUniteBirKonuBirTestBir = true,
                true,
                'sinif11_temel_mat_1');
          }
