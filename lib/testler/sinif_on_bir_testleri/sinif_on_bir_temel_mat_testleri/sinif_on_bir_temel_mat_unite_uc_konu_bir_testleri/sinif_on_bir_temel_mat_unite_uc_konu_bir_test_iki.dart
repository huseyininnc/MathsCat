...
class SinifOnBirTemelMatUniteUcKonuBirTestIki extends StatefulWidget {
  @override
  _SinifOnBirTemelMatUniteUcKonuBirTestIkiState createState() =>
      _SinifOnBirTemelMatUniteUcKonuBirTestIkiState();
}

class _SinifOnBirTemelMatUniteUcKonuBirTestIkiState
    extends State<SinifOnBirTemelMatUniteUcKonuBirTestIki> {
  List<String> sorular = VeriTabaniSinifOnBirTemelMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirTemelMat()
      .sinifOnBirTemelMatUniteUcKonuBirTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_temel_mat/soruresim_sinif_on_bir_temel_mat_unite_uc_konu_bir_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirTemelMatUniteUcKonuBirTestIki = true,
                true,
                'sinif11_temel_mat_6');
          }
