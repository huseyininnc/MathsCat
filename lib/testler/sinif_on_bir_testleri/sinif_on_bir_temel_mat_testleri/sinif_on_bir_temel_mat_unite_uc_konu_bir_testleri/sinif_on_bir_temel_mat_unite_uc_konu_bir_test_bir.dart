...
class SinifOnBirTemelMatUniteUcKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirTemelMatUniteUcKonuBirTestBirState createState() =>
      _SinifOnBirTemelMatUniteUcKonuBirTestBirState();
}

class _SinifOnBirTemelMatUniteUcKonuBirTestBirState
    extends State<SinifOnBirTemelMatUniteUcKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirTemelMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirTemelMat()
      .sinifOnBirTemelMatUniteUcKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_temel_mat/soruresim_sinif_on_bir_temel_mat_unite_uc_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirTemelMatUniteUcKonuBirTestBir = true,
                true,
                'sinif11_temel_mat_5');
          }
