...
class SinifOnBirTemelMatUniteIkiKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirTemelMatUniteIkiKonuBirTestBirState createState() =>
      _SinifOnBirTemelMatUniteIkiKonuBirTestBirState();
}

class _SinifOnBirTemelMatUniteIkiKonuBirTestBirState
    extends State<SinifOnBirTemelMatUniteIkiKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirTemelMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirTemelMat()
      .sinifOnBirTemelMatUniteIkiKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_temel_mat/soruresim_sinif_on_bir_temel_mat_unite_iki_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirTemelMatUniteIkiKonuBirTestBir = true,
                true,
                'sinif11_temel_mat_3');
          }
