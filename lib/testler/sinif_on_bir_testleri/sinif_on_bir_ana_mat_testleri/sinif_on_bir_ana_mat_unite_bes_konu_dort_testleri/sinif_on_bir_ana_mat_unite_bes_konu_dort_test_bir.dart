...
class SinifOnBirAnaMatUniteBesKonuDortTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBesKonuDortTestBirState createState() =>
      _SinifOnBirAnaMatUniteBesKonuDortTestBirState();
}

class _SinifOnBirAnaMatUniteBesKonuDortTestBirState
    extends State<SinifOnBirAnaMatUniteBesKonuDortTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteBesKonuDortTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bes_konu_dort_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBesKonuDortTestBir = true,
                true,
                'sinif11_ana_mat_17');
          }
