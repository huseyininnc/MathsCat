...
class SinifOnBirAnaMatUniteDortKonuIkiTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteDortKonuIkiTestBirState createState() =>
      _SinifOnBirAnaMatUniteDortKonuIkiTestBirState();
}

class _SinifOnBirAnaMatUniteDortKonuIkiTestBirState
    extends State<SinifOnBirAnaMatUniteDortKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteDortKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_dort_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteDortKonuIkiTestBir = true,
                true,
                'sinif11_ana_mat_13');
          }
