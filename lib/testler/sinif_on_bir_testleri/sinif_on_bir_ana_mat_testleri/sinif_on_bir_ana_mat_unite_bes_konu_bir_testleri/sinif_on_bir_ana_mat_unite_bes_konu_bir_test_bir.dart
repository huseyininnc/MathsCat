...
class SinifOnBirAnaMatUniteBesKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBesKonuBirTestBirState createState() =>
      _SinifOnBirAnaMatUniteBesKonuBirTestBirState();
}

class _SinifOnBirAnaMatUniteBesKonuBirTestBirState
    extends State<SinifOnBirAnaMatUniteBesKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteBesKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bes_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBesKonuBirTestBir = true,
                true,
                'sinif11_ana_mat_14');
          }
