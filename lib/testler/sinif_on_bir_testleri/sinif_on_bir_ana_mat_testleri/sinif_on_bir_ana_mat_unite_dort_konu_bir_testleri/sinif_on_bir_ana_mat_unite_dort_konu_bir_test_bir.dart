...
class SinifOnBirAnaMatUniteDortKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteDortKonuBirTestBirState createState() =>
      _SinifOnBirAnaMatUniteDortKonuBirTestBirState();
}

class _SinifOnBirAnaMatUniteDortKonuBirTestBirState
    extends State<SinifOnBirAnaMatUniteDortKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteDortKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_dort_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteDortKonuBirTestBir = true,
                true,
                'sinif11_ana_mat_12');
          }
