...
class SinifOnBirAnaMatUniteBirKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBirKonuBirTestBirState createState() =>
      _SinifOnBirAnaMatUniteBirKonuBirTestBirState();
}

class _SinifOnBirAnaMatUniteBirKonuBirTestBirState
    extends State<SinifOnBirAnaMatUniteBirKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteBirKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bir_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBirKonuBirTestBir = true,
                true,
                'sinif11_ana_mat_1');
          }
