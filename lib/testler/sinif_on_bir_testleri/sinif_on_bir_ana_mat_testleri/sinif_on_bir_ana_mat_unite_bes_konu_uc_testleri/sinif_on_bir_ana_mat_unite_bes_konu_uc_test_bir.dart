...
class SinifOnBirAnaMatUniteBesKonuUcTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBesKonuUcTestBirState createState() =>
      _SinifOnBirAnaMatUniteBesKonuUcTestBirState();
}

class _SinifOnBirAnaMatUniteBesKonuUcTestBirState
    extends State<SinifOnBirAnaMatUniteBesKonuUcTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteBesKonuUcTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bes_konu_uc_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBesKonuUcTestBir = true,
                true,
                'sinif11_ana_mat_16');
          }
