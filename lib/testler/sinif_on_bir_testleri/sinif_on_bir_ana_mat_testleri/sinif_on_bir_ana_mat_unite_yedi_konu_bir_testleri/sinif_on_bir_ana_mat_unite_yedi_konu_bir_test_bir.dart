...
class SinifOnBirAnaMatUniteYediKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteYediKonuBirTestBirState createState() =>
      _SinifOnBirAnaMatUniteYediKonuBirTestBirState();
}

class _SinifOnBirAnaMatUniteYediKonuBirTestBirState
    extends State<SinifOnBirAnaMatUniteYediKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteYediKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_yedi_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteYediKonuBirTestBir = true,
                true,
                'sinif11_ana_mat_19');
          }
