...
class SinifOnBirAnaMatUniteYediKonuBirTestIki extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteYediKonuBirTestIkiState createState() =>
      _SinifOnBirAnaMatUniteYediKonuBirTestIkiState();
}

class _SinifOnBirAnaMatUniteYediKonuBirTestIkiState
    extends State<SinifOnBirAnaMatUniteYediKonuBirTestIki> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteYediKonuBirTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_yedi_konu_bir_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteYediKonuBirTestIki = true,
                true,
                'sinif11_ana_mat_20');
          }
