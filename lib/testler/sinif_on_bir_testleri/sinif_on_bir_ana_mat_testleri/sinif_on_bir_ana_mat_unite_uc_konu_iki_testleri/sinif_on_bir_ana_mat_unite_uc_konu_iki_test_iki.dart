...
class SinifOnBirAnaMatUniteUcKonuIkiTestIki extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteUcKonuIkiTestIkiState createState() =>
      _SinifOnBirAnaMatUniteUcKonuIkiTestIkiState();
}

class _SinifOnBirAnaMatUniteUcKonuIkiTestIkiState
    extends State<SinifOnBirAnaMatUniteUcKonuIkiTestIki> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteUcKonuIkiTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_uc_konu_iki_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteUcKonuIkiTestIki = true,
                true,
                'sinif11_ana_mat_10');
          }
