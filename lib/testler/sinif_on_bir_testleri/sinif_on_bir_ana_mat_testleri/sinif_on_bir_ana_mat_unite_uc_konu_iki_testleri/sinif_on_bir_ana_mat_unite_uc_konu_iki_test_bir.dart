...
class SinifOnBirAnaMatUniteUcKonuIkiTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteUcKonuIkiTestBirState createState() =>
      _SinifOnBirAnaMatUniteUcKonuIkiTestBirState();
}

class _SinifOnBirAnaMatUniteUcKonuIkiTestBirState
    extends State<SinifOnBirAnaMatUniteUcKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteUcKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_uc_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteUcKonuIkiTestBir = true,
                true,
                'sinif11_ana_mat_9');
          }
