...
class SinifOnBirAnaMatUniteUcKonuUcTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteUcKonuUcTestBirState createState() =>
      _SinifOnBirAnaMatUniteUcKonuUcTestBirState();
}

class _SinifOnBirAnaMatUniteUcKonuUcTestBirState
    extends State<SinifOnBirAnaMatUniteUcKonuUcTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().soruResimleriOnBirli;
  List<String> cevaplar =
      VeriTabaniSinifOnBirAnaMat().sinifOnBirAnaMatUniteUcKonuUcTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_uc_konu_uc_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteUcKonuUcTestBir = true,
                true,
                'sinif11_ana_mat_11');
          }
