...
class SinifOnBirAnaMatUniteBirKonuIkiTestIki extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBirKonuIkiTestIkiState createState() =>
      _SinifOnBirAnaMatUniteBirKonuIkiTestIkiState();
}

class _SinifOnBirAnaMatUniteBirKonuIkiTestIkiState
    extends State<SinifOnBirAnaMatUniteBirKonuIkiTestIki> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteBirKonuIkiTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bir_konu_iki_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBirKonuIkiTestIki = true,
                true,
                'sinif11_ana_mat_3');
          }
