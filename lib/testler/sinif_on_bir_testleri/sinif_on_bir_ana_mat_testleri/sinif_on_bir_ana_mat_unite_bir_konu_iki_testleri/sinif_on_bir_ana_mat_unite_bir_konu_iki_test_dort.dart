...
class SinifOnBirAnaMatUniteBirKonuIkiTestDort extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBirKonuIkiTestDortState createState() =>
      _SinifOnBirAnaMatUniteBirKonuIkiTestDortState();
}

class _SinifOnBirAnaMatUniteBirKonuIkiTestDortState
    extends State<SinifOnBirAnaMatUniteBirKonuIkiTestDort> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteBirKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bir_konu_iki_test_dort/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBirKonuIkiTestDort = true,
                true,
                'sinif11_ana_mat_5');
          }
