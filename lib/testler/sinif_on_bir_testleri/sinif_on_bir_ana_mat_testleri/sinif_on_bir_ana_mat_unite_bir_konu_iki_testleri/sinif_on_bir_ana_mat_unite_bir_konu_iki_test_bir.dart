...
class SinifOnBirAnaMatUniteBirKonuIkiTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBirKonuIkiTestBirState createState() =>
      _SinifOnBirAnaMatUniteBirKonuIkiTestBirState();
}

class _SinifOnBirAnaMatUniteBirKonuIkiTestBirState
    extends State<SinifOnBirAnaMatUniteBirKonuIkiTestBir> {
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bir_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBirKonuIkiTestBir = true,
                true,
                'sinif11_ana_mat_2');
          }
