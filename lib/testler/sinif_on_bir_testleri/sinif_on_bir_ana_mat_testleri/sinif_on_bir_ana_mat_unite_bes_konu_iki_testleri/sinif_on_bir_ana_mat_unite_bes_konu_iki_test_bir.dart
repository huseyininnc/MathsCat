...
class SinifOnBirAnaMatUniteBesKonuIkiTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteBesKonuIkiTestBirState createState() =>
      _SinifOnBirAnaMatUniteBesKonuIkiTestBirState();
}

class _SinifOnBirAnaMatUniteBesKonuIkiTestBirState
    extends State<SinifOnBirAnaMatUniteBesKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().soruResimleriOnBirli;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteBesKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_bes_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteBesKonuIkiTestBir = true,
                true,
                'sinif11_ana_mat_15');
          }
