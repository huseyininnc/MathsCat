...
class SinifOnBirAnaMatUniteIkiKonuBirTestBir extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteIkiKonuBirTestBirState createState() =>
      _SinifOnBirAnaMatUniteIkiKonuBirTestBirState();
}

class _SinifOnBirAnaMatUniteIkiKonuBirTestBirState
    extends State<SinifOnBirAnaMatUniteIkiKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteIkiKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_iki_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteIkiKonuBirTestBir = true,
                true,
                'sinif11_ana_mat_6');
          }
