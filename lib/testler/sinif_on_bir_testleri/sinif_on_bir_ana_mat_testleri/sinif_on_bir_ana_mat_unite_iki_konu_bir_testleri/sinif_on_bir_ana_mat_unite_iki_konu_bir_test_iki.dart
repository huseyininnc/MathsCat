...
class SinifOnBirAnaMatUniteIkiKonuBirTestIki extends StatefulWidget {
  @override
  _SinifOnBirAnaMatUniteIkiKonuBirTestIkiState createState() =>
      _SinifOnBirAnaMatUniteIkiKonuBirTestIkiState();
}

class _SinifOnBirAnaMatUniteIkiKonuBirTestIkiState
    extends State<SinifOnBirAnaMatUniteIkiKonuBirTestIki> {
  List<String> sorular = VeriTabaniSinifOnBirAnaMat().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifOnBirAnaMat()
      .sinifOnBirAnaMatUniteIkiKonuBirTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_on_bir/soru_resimleri_sinif_on_bir_ana_mat/soruresim_sinif_on_bir_ana_mat_unite_iki_konu_bir_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiSinifOnBirAnaMatUniteIkiKonuBirTestIki = true,
                true,
                'sinif11_ana_mat_7');
          }
