...
class UniteUcKonuDortTestIki extends StatefulWidget {
  @override
  _UniteUcKonuDortTestIkiState createState() => _UniteUcKonuDortTestIkiState();
}

class _UniteUcKonuDortTestIkiState extends State<UniteUcKonuDortTestIki> {
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_uc_konu_dort_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteUcKonuDortTestIki = true,
                true,
                'sinif9_9');
          }
