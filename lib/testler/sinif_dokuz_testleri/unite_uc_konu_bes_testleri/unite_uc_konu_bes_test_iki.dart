...
class UniteUcKonuBesTestIki extends StatefulWidget {
  @override
  _UniteUcKonuBesTestIkiState createState() => _UniteUcKonuBesTestIkiState();
}

class _UniteUcKonuBesTestIkiState extends State<UniteUcKonuBesTestIki> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteUcKonuBesTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_uc_konu_bes_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteUcKonuBesTestIki = true,
                true,
                'sinif9_11');
          }
