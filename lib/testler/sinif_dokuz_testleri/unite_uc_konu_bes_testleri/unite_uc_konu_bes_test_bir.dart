...
class UniteUcKonuBesTestBir extends StatefulWidget {
  @override
  _UniteUcKonuBesTestBirState createState() => _UniteUcKonuBesTestBirState();
}

class _UniteUcKonuBesTestBirState extends State<UniteUcKonuBesTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteUcKonuBesTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_uc_konu_bes_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteUcKonuBesTestBir = true,
                true,
                'sinif9_10');
          }
