...
class UniteDortKonuUcTestIki extends StatefulWidget {
  @override
  _UniteDortKonuUcTestIkiState createState() => _UniteDortKonuUcTestIkiState();
}

class _UniteDortKonuUcTestIkiState extends State<UniteDortKonuUcTestIki> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteDortKonuUcTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_dort_konu_uc_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteDortKonuUcTestIki = true,
                true,
                'sinif9_17');
          }
