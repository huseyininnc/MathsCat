...
class UniteDortKonuUcTestBir extends StatefulWidget {
  @override
  _UniteDortKonuUcTestBirState createState() => _UniteDortKonuUcTestBirState();
}

class _UniteDortKonuUcTestBirState extends State<UniteDortKonuUcTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteDortKonuUcTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_dort_konu_uc_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteDortKonuUcTestBir = true,
                true,
                'sinif9_16');
          }
