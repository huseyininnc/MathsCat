...
class UniteIkiKonuBirTestBir extends StatefulWidget {
  @override
  _UniteIkiKonuBirTestBirState createState() => _UniteIkiKonuBirTestBirState();
}

class _UniteIkiKonuBirTestBirState extends State<UniteIkiKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteIkiKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_iki_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteIkiKonuBirTestBir = true,
                true,
                'sinif9_2');
          }
