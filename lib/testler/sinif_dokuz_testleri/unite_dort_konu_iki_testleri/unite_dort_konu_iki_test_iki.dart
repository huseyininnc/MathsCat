...
class UniteDortKonuIkiTestIki extends StatefulWidget {
  @override
  _UniteDortKonuIkiTestIkiState createState() =>
      _UniteDortKonuIkiTestIkiState();
}

class _UniteDortKonuIkiTestIkiState extends State<UniteDortKonuIkiTestIki> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifDokuz().uniteDortKonuIkiTestIkiCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_dort_konu_iki_test_iki/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteDortKonuIkiTestIki = true,
                true,
                'sinif9_15');
          }
