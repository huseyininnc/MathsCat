...
class UniteDortKonuIkiTestBir extends StatefulWidget {
  @override
  _UniteDortKonuIkiTestBirState createState() =>
      _UniteDortKonuIkiTestBirState();
}

class _UniteDortKonuIkiTestBirState extends State<UniteDortKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifDokuz().uniteDortKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_dort_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteDortKonuIkiTestBir = true,
                true,
                'sinif9_14');
          }
