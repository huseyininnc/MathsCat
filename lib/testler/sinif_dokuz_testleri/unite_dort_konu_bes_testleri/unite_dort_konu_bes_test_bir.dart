...
class UniteDortKonuBesTestBir extends StatefulWidget {
  @override
  _UniteDortKonuBesTestBirState createState() =>
      _UniteDortKonuBesTestBirState();
}

class _UniteDortKonuBesTestBirState extends State<UniteDortKonuBesTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifDokuz().uniteDortKonuBesTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_dort_konu_bes_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteDortKonuBesTestBir = true,
                true,
                'sinif9_19');
          }
