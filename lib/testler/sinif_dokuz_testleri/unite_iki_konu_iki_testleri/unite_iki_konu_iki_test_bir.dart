...
class UniteIkiKonuIkiTestBir extends StatefulWidget {
  @override
  _UniteIkiKonuIkiTestBirState createState() => _UniteIkiKonuIkiTestBirState();
}

class _UniteIkiKonuIkiTestBirState extends State<UniteIkiKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteIkiKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_iki_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteIkiKonuIkiTestBir = true,
                true,
                'sinif9_3');
          }
