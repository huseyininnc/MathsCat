...
class UniteUcKonuIkiTestBir extends StatefulWidget {
  @override
  _UniteUcKonuIkiTestBirState createState() => _UniteUcKonuIkiTestBirState();
}

class _UniteUcKonuIkiTestBirState extends State<UniteUcKonuIkiTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteUcKonuIkiTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_uc_konu_iki_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteUcKonuIkiTestBir = true,
                true,
                'sinif9_5');
          }
