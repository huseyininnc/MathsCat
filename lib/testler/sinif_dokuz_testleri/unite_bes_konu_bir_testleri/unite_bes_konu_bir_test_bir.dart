...
import 'package:mathscat/test_sonuc_sayfasi.dart';
...
class UniteBesKonuBirTestBir extends StatefulWidget {
  @override
  _UniteBesKonuBirTestBirState createState() => _UniteBesKonuBirTestBirState();
}

class _UniteBesKonuBirTestBirState extends State<UniteBesKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().soruResimleriOnBirli;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteBesKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_bes_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteBesKonuBirTestBir = true,
                true,
                'sinif9_20');
          }
