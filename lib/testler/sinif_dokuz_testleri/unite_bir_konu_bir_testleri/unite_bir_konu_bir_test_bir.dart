...
class UniteBirKonuBirTestBir extends StatefulWidget {
  @override
  _UniteBirKonuBirTestBirState createState() => _UniteBirKonuBirTestBirState();
}

class _UniteBirKonuBirTestBirState extends State<UniteBirKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar = VeriTabaniSinifDokuz().uniteBirKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_bir_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteBirKonuBirTestBir = true,
                true,
                'sinif9_1');
          }
