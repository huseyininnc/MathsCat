...
class UniteDortKonuBirTestBir extends StatefulWidget {
  @override
  _UniteDortKonuBirTestBirState createState() =>
      _UniteDortKonuBirTestBirState();
}

class _UniteDortKonuBirTestBirState extends State<UniteDortKonuBirTestBir> {
  List<String> sorular = VeriTabaniSinifDokuz().defaultSoruResimleri;
  List<String> cevaplar =
      VeriTabaniSinifDokuz().uniteDortKonuBirTestBirCevaplar;
            ...
            children: [
              ...
              Column(
                children: [
                  Image(
                    image: AssetImage(
                        'assets/soru_resimleri/soru_resimleri_sinif_dokuz/soruresim_sinif_dokuz_unite_dort_konu_bir_test_bir/${sorular[indexSoru]}'),
                  ),
                ],
              ),
              SizedBox(
          ...
          if (Provider.of<Puan>(context, listen: false)
            ...
            Provider.of<Puan>(context, listen: false).testBittiMiKaydet(
                Provider.of<Puan>(context, listen: false)
                    .testBittiMiUniteDortKonuBirTestBir = true,
                true,
                'sinif9_13');
          }
