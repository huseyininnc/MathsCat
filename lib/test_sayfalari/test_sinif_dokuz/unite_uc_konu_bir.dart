...
import 'package:mathscat/testler/sinif_dokuz_testleri/unite_uc_konu_bir_testleri/unite_uc_konu_bir_test_bir.dart';
import 'package:mathscat/widgets/app_bar_gradient_widget.dart';
import 'package:mathscat/widgets/test_basligi_row_widget.dart';

class UniteUcKonuBir extends StatelessWidget {
  @override
            ...
            TestBasligiRowWidget(
              ...
              onPress: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => UniteUcKonuBirTestBir(),
                  ),
                );
              },
            ),
