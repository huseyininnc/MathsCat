...
class UniteDortKonuIki extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Üçgenlerde Eşlik ve Benzerlik'),
            ...
            TestBasligiRowWidget(
              ...
              onPress: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => UniteDortKonuIkiTestBir(),
                  ),
                );
              },
              onPress2: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => UniteDortKonuIkiTestIki(),
                  ),
                );
              },
            ),
