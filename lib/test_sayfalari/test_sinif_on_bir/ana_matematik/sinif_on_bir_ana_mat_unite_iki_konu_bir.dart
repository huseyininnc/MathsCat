...
import 'package:mathscat/testler/sinif_on_bir_testleri/sinif_on_bir_ana_mat_testleri/sinif_on_bir_ana_mat_unite_iki_konu_bir_testleri/sinif_on_bir_ana_mat_unite_iki_konu_bir_test_bir.dart';
...
class SinifOnBirAnaMatUniteIkiKonuBir extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('D. Analitik İncelenmesi'),
            ...
            TestBasligiRowWidget(
              ...
              onPress: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SinifOnBirAnaMatUniteIkiKonuBirTestBir(),
                  ),
                );
              },
              onPress2: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SinifOnBirAnaMatUniteIkiKonuBirTestIki(),
                  ),
                );
              },
            ),
